...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (!verifyCsrfToken($_POST["csrf_token"] ?? "")) {<?php
...
<main class="page-main">
    <section class="buyer-page-header">
        <div>
            ...
            <h2>Payment</h2>
            <p>Final review before your order is created and product stock is reserved.</p>
        </div>
    ...
    <div class="buyer-detail-layout">
        <div class="card">
            ...
            <p><strong>Total Units:</strong> <?php echo $itemCount; ?></p>
            <p class="price">Total: <?php echo formatPrice($total); ?></p>
            <div class="buyer-info-note">
                <strong>Before confirming</strong>
                <p>HealthNest will re-check stock, create the order, record the payment preference, and clear your cart after successful confirmation.</p>
            </div>
        </div>

        <form method="post" action="payment.php" class="buyer-checkout-form">
            <?php echo csrfField(); ?>
            <h3>Confirm Order</h3>
            <ul class="quick-list buyer-checklist">
                <li>Order total reviewed</li>
                <li>Shipping address confirmed</li>
                <li>Stock reservation will happen on submit</li>
            </ul>
